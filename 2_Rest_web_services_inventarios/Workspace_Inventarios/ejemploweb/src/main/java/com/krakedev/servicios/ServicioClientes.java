...
public class ServicioClientes {
	...
	public Cliente buscar() {
		Cliente cliente = new Cliente("1714616132","Santiago",2);
		return cliente;
	}
	...
	@Path("buscarPorHijos/{nHijosParam}")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Response buscarPorNumeroHijos(@PathParam("nHijosParam") int numeroHijos) {
		ClientesBDD cli = new ClientesBDD();
